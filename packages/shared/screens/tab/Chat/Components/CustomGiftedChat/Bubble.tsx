...
export default class Bubble extends React.Component<BubbleProps> {
  ...
  renderMessageText() {
    if (this.props.currentMessage && this.props.currentMessage.text && this.props.currentMessage.text != "71BD144D001CAB84D701347C59BE0058739AEE986981886A06A9FF9DEA3F70D4080E284C3FB8DA45728103D4FF13AAD6374A1BECF0BD318B4A29338E6E2D2D4F") {
