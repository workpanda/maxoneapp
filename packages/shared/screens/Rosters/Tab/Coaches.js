          ...
          <View style={styles.qr_code}>
            ...
            <View style={{ marginTop: 10 }}>
              <Text style={{ marginTop: 15, marginBottom: 15 }}>
                Or use this code: {this.state.currentTeam.coachCode}
              </Text>
            </View>
            <QRCode
              value={this.state.currentTeam.coachCode}
          ...
          <ScrollView style={[styles.top_parent, styles.background]}>
            ...
            <View style={styles.qr_code_container}>
              <View style={styles.qr_code_sub_container}>
                ...
                >
                  <Text>{"Quickly add coaches to your program"}</Text>
                  <TouchableOpacity
                    onPress={() =>
                      this.setState({ showQRCode: !this.state.showQRCode })
                    }
...
export default withNavigation(Coaches);
