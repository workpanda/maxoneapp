...
import CustomVideo from "@m1/shared/screens/Profile/CustomVideo";
        ...
        <ScrollView style={{ width: "100%", flex: 1 }}>
          ...
          <View style={styles.team_container}>
            <Text style={styles.team_text}>
              {currentTeam && currentTeam.customName
                ? `${currentTeam.customName}`
                : `${currentTeam.name} ${currentTeam.sport}`}
            </Text>
          </View>
          ...
          <View style={styles.navigation_container}>
            {this.state.appContext.isPlayer ||
            this.state.appContext.isAthlete ||
            this.state.appContext.isGuardian ? (
              <CustomVideo
                videoProps={{
                  shouldPlay: false,
                  resizeMode: Video.RESIZE_MODE_CONTAIN,
